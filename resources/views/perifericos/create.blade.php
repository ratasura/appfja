...
<div class="row">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        ...
        @endif
        {!! Form::open(array('url'=>'perifericos','method'=>'POST', 'autocomplete'=>'off'))  !!}
        {{Form::token()}}
                            ...
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                ...
                                {{-- <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            ...
                                            <label>Ubicacion</label>
                                                <select name="idubicacion" class="form-control">
                                                    @foreach ($ubicaciones as $ub)
                                                        <option value="{{$ub->id}}">{{$ub->edificio.'  '.$ub->piso.'  '.$ub->unidad}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                 </div> --}}
                                 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                     ...
                                     <input type="text" value="" name="idubicacion" placeholder="aqui" class="form-control" id="locations" />
                                     </div>
