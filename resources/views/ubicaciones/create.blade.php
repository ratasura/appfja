...
<div class="row">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        ...
        @endif
        {!! Form::open(array('url'=>'ubicaciones','method'=>'POST', 'autocomplete'=>'off'))  !!}
        {{Form::token()}}
                            ...
                            <div class="form-group">
                                <label>Cantón</label>
                                    <select name="canton" class="form-control">
                                            <option value="" selected disabled hidden>Escoja un cantón</option>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="form-group">
                                    ...
                                    <select name="edificio" class="form-control">
                                            <option value="" selected disabled hidden>Escoja un edificio</option>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="form-group">
                                    ...
                                    <select name="piso" class="form-control">
                                            <option value="" selected disabled hidden>Escoja un piso</option>
                            ...
                            <div class="form-group">
                                <label>Unidad</label>
                                    <select name="unidad" class="form-control">
                                            <option value="" selected disabled hidden>Escoja una unidad</option>
                                ...
                                <div class="form-group">
                                    <label>Técnico Asignado</label>
                                        <select name="tecnico" class="form-control">
                                                <option value="" selected disabled hidden>Escoja un técnico</option>
